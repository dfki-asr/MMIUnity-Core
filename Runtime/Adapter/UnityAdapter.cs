...
namespace MMIAdapterUnity
{
    ...
    public class UnityAdapter : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            MMICSharp.Logger.Instance = new UnityLogger(isServerBuild)
            {
                //Log everything
        ...
        this.mmiRegisterAddress.Address = "127.0.0.1";
            ...
            {
                MMICSharp.Logger.Log(MMICSharp.Log_level.L_ERROR, "Cannot parse the command line arguments. The adapter is meant to be started with specified arguments only.");
                return;
            }
#endif
